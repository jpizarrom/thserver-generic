...
public class LoginExistsException extends DuplicateInstanceException {

    public LoginExistsException(Object key, String className) {
        super("Login exists", key, className);
    }
